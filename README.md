...
Λογισμικό προτύπου
-------------------------
Το πρότζεκτ μας θα είναι προγραμματισμένο στη γλώσσα Python χρησιμοποιώντας την εφαρμογή της Microsoft MicrοBit Makecode. Στην εικόνα που ακολουθεί, παρουσιάζεται το διάγραμμα ροής του προγράμματός μας (αρχική προσέγγιση). 
